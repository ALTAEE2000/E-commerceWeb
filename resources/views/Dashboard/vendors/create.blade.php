                                        ...
                                        <form class="form" action="{{ route('admin.vendors.store') }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">ايميل</label>
...
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC60wIQlFgg72XnvX6lPcK9J2Ln3CkRhWQ&libraries=places&callback=initAutocomplete&language=ar&region=EG
                                         async defer"></script>
@stop
