    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span {{--  class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\MainCategory::defaultCategory()->count() }}</span>  --}} class="badge badge badge-danger badge-pill float-right mr-2">23</span>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    ...
                    <span {{--  class="badge badge badge-success badge-pill float-right mr-2">{{ App\Models\Vendor::count() }}</span>  --}} class="badge badge badge-success badge-pill float-right mr-2">334</span>
